...
const requirementDB = mongoose.createConnection('mongodb://localhost:27017/m-app');

requirementDB.on('connected', () => {
    console.log('requirementDB  connected');
});

// Handle connection errors
requirementDB.on('error', (err) => {
...
const consultationSchema = new mongoose.Schema({
    ...
    regulatoryRequirements: { type: String, required: true },
    sustainabilityGoals: { type: String, required: true },
...
//creating model
const consultationModel = requirementDB.model('Consulation',consultationSchema);
...
app.get('/req/consultations', async (req, res) => {
    try {
